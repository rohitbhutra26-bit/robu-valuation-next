        ...
        <div className="flex flex-1 overflow-hidden">
          ...
          <main className="flex-1 overflow-y-auto min-w-0">
            {isLoading ? (
              ...
              <div className="mx-auto max-w-5xl 2xl:max-w-[1380px] 2xl:flex 2xl:gap-6">
                ...
                {/* Company header — always visible; export action lives inside it */}
                <CompanyHeader
                  company={company}
                  financials={financials}
                  ...
                  headerAction={<ExportReport company={company} financials={financials} assumptions={assumptions} />}
                />
