...
export const SECTOR_PROFILES: Record<string, SectorProfile> = {
  ...
  // ── more real Screener labels found by the data-quality scan ──
  'Other Bank':                    pbProfile('Bank', 1.5, 3, 12.5, 9, 14),
  'Small Finance Bank':            pbProfile('Small Finance Bank', 1.6, 3.5, 13, 9, 15),
  'Auto Components & Equipments':  peProfile('Auto Ancillaries', 25),
  'Auto Components & Equipment':   peProfile('Auto Ancillaries', 25),
  ...
  'Trading':                       peProfile('Trading', 15),
  'Diversified':                   peProfile('Conglomerate', 22),
